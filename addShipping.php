...
if (isset($_POST['c_id'])) {
    ...
    $hasDefShippingAdress = $customerController->hasDefShippingAddress($customerId);
} else {
    echo "Hibás kérés.";
}
?>
...
<html>
<head>
    <title>Új Szállítási cím</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
<div class="container mt-5">
    <h1 class="mb-4">Új Szállítási cím Létrehozása</h1>
